...
function install {
    ...
    echo " - $PACKAGE_NAME's data will be stored in /DATA/AppData/roon/$PACKAGE_NAME"
...
Type=simple
User=root
Environment=ROON_DATAROOT=/DATA/AppData/roon
Environment=ROON_ID_DIR=/DATA/AppData/roon
...
export ROON_DATAROOT=/DATA/AppData/roon
export ROON_ID_DIR=/DATA/AppData/roon
